...
const FIXED = [
  ...
  ["sign", 1.4, -7.2, 0],
  ["rocket", -11, -5.2, 0.4],
  ["firework", -9.2, -4.2, 0], ["firework", -9.0, -5.4, 0], ["firework", -9.6, -6.4, 0],
  ["firework", -12.4, -3.6, 0], ["firework", -10.4, -3.2, 0],
  ["campfire", 0.4, 1.2, 0],
  ["bench", 0.4, -0.7, 0], ["bench", -1.5, 1.4, 1.35], ["bench", 2.3, 1.5, -1.35],
  ["log", 1.6, 2.9, 0.5], ["log", -0.7, 3.0, -0.4], ["log", 0.5, 3.4, 0.1],
  ["deckchair", -6.2, 0.4, 0.3], ["deckchair", -8.2, 0.2, 0], ["deckchair", -10.2, 0.4, -0.25],
  ["deckchair", -3.4, 3.0, 1.2], ["deckchair", -3.6, 5.4, 1.5],
  ["parasol", -7.2, 0.1, 0], ["parasol", -11.2, 0.3, 0], ["parasol", -3.0, 4.2, 0],
  ...
  ["crate", 6.6, 2.0, 0.6], ["crate", -5.6, -5.6, 0.2], ["crate", -5.0, -5.4, 0.9],
  ["barrel", 8.8, 5.2, 0], ["barrel", 5.0, -6.6, 0], ["barrel", -5.4, -6.6, 0],
  ["car", 10.8, 3.2, 0.12],
  ["bucket", -5.4, 2.6, 0], ["bucket", 7.9, 4.4, 0], ["bucket", -12.4, 2.4, 0], ["bucket", 1.8, -1.8, 0],
  ["bush", 4.6, -2.2, 0], ["bush", 12.6, -1.2, 0], ["bush", -2.4, -6.4, 0], ["bush", 12.4, 7.4, 0],
  ["bush", -13, -1, 0], ["bush", 6.2, 7.8, 0],
  ["pine", -13, -7.6, 0], ["pine", -7.6, -7.8, 0], ["pine", -4, -8, 0], ["pine", 4.6, -8, 0],
  ["pine", 12.6, -7.8, 0], ["pine", 13, -3.6, 0], ["pine", -13.2, -3, 0], ["pine", 12.8, 0.8, 0],
  ["duck", -9.4, 4.2, 0.4], ["duck", -7.4, 5.4, 2.2], ["duck", -8.2, 3.4, 4], ["duck", -10.2, 5.6, 1],
  ["ball", -5.6, 6.6, 0], ["ball", -2.2, 7.4, 0], ["ball", 8.4, 7.6, 0]
];

for (let i = 0; i < 8; i++) FIXED.push(["fence", -11.6 + i * 2.05, -8.55, 0]);

const SCATTER = [["tuft", 46], ["flower", 22], ["pebble", 16], ["mushroom", 10], ["apple", 12]];
